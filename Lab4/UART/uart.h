...
Std_ReturnType UART_Init(uart_t *_uart);
Std_ReturnType UART_SendChar(uart_t *_uart,uint8_t data);
Std_ReturnType UART_SendString(uart_t *_uart,const char *str);
uint8_t UART_ReceiveChar(uart_t *_uart,Std_ReturnType *retVal);
